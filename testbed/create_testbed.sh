...
echo 'disk = [ "file:'$IMAGE_PATH'/$NODENAME.img,sda1,w" ]' >> $CONFIG_PATH/node-xencfg.template
# org: echo 'disk = [ "file:'$IMAGE_PATH'/$NODENAME.img,sda1,w", "file:'$SWAP_PATH'/$NODENAME-swap.img,sda2,w" ]' >> $CONFIG_PATH/node-xencfg.template
...
echo 'root = "/dev/sda1 ro"' >> $CONFIG_PATH/node-xencfg.template
